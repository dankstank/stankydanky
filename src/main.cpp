...
uint256 hashGenesisBlock("0x00000f8761cedcd3f119c14724e4ef571ee137da3f14398557552aee5b25d678");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // DankCoin: starting difficulty is 1 / 2^12
...
{
    // DankCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 2040; // DankCoin: 15 day
static const int64 nTargetSpacing = 102; // DankCoin: 2 minute
...
{
    // DankCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000e15e809e5d6a8bbc088e7e9006f5aae4789228ec383db49bb400f49fda2");
    }
...
bool InitBlockIndex() {
    ...
    // vMerkleTree: b0019d92bc054f7418960c91e252e7d24c77719c7a30128c5f6a827c73095d2a 
		...
		const char* pszTimestamp = "JapanToday We ate all the whales.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0x118339304cdda0d12d97120aa7306085b72a272f931c2b6fb92d294747f2249b"));
...
unsigned char pchMessageStart[4] = { 0xce, 0xe3, 0xc9, 0x1e }; // DankCoin: increase each by adding 6 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DankCoinMiner : ProcessBlock, block not accepted");
    }
